...
parser.add_argument(
    ...
    default="/home/sulabh/Documents/work/dmgdetection/pytorch/model/class_11_no_top.pth",
...
print('newdict[model]')
print(newdict['model']['bbox_pred.weight'])
...
newdict['model'] = removekey(_d['model'],
                             [
                                 ...
                                 'bbox_pred.bias',
                                 'bbox_pred.weight',
                                 'mask_fcn_logits.bias',    # # Added
                                 'mask_fcn_logits.weight'     # # Added
                             ])
